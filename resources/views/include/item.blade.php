            ...
            <div class="row">
                <div class="col-5">
                    <div class="ms-4 mt-3 me-4">
                        <img src="/user_icon/{{ $barang->foto_barang }}" width="400px" class="shadow p1 img-fluid"> 
                    </div>
                    ...
                    <div class="ms-3 mt-3 me-3">
                        ...
                        <div class="ms-1 mt-4">
                           ...
                           <label for="size" class="d-flex"> Ukuran : <p> {{ $barang->size }} </p></label>
                            <input type='number' style="width:100px; height:35px;" id="counter" class="text-center form-control d-inline" placeholder="1" name="jumlah">
                        ...
                        <div class="ms-1 d-flex mt-4 mb-4">
                            <button class="btn btn-outline-secondary position-relative"><img src="/user_icon/keranjang.png" height="20px"></button>
