            ...
            <div class="row">
                <div class="col-4">
                    <div class="m-2 justify-content-center text-center">
                        ...
                        <img src="/user_icon/loginuser/{{ $foto }}" width="200px" class="rounded-circle border border-dark p-1 justify-content-center ms-3">
                        <div class="mt-3">
                ...
                <div class=" col-8 mb-2">
                    <div class="ms-5 mt-2">
                        ...
                        <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="{{ $nama }}">
                        </div>
                        <div class=" mb-1">
                            <label for="exampleFormControlInput1" class="form-label fw-bolder">Username </label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="{{ $username }}">
                        </div>
                        <div class=" mb-1">
                            <label for="exampleFormControlInput1" class="form-label fw-bolder">No Telepon </label>
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="{{ $telepon }}">
                        </div>
                        <div class=" mb-1">
                            <label for="exampleFormControlInput1" class="form-label fw-bolder">Alamat </label>
                            <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" value="{{ $alamat }}">
                        </div>
                        <div class=" mb-1">
