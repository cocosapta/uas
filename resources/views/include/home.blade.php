...
@section('container')
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="user_icon/item/slide1.png" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="user_icon/item/slide2.png" class="d-block w-100" alt="...">
    </div>
  </div>
                   ...
                   @foreach ($barang as $brg)
                      <div class="col mb-5"><a href="/item/{{ $brg->id_barang }}" class="text-decoration-none">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="user_icon/{{ $brg->foto_barang }}" alt="..." />
                            <!-- Product details-->
